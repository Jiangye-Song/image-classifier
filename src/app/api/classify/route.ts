...
Respond ONLY with valid JSON in this exact format (no markdown, no code blocks):
{
  ...
  "isOverfilled": "<Yes | Little | No | N/A>"
}
...
- "isOverfilled" must be exactly "Yes" if the bin is clearly overfilled (materials sticking significantly above the bin rim), "Little" if there is a slight overfill but within a reasonable range (materials barely above the rim), "No" if the bin is not overfilled, or "N/A" if no bin is visible in the image
